...
lb_Result_Text = QLabel('')

layout_test_res = QVBoxLayout()
layout_test_res.addWidget(lb_Result_Text)
...
def show_test_res():
    ...
    RadioGroupBox.hide()
    AnsGroupBox.hide()
    lb_Result_Text.setText('Ваш результат ' + str(points) + ' из ' + str(questions_count))
    ResultGroupBox.show()
